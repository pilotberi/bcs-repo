/*
	...
	Version : 2024
	Generated On : Wed Jan 07 2026 15:40:19 GMT+0530 (India Standard Time)
  ...
  for (var row = 0; row < sheetData.length; row++) {
    ...
    if (rowData[1] && rowData[1].length > 0) {
      ...
      if (checkStatus == true) {
        ...
        data["working_principle"] = rowData[1] || null;
...
function validate(rowData) {
  ...
  if (rowData[1] == null || rowData[1] === '') { //this is to validate working_principle
    s_info(Strings.VALIDATION_ERROR_TITLE, Strings.WORKINGPRINCIPLE_INVALID_WORKING_PRINCIPLE, dlgOptions);
    return false;
  }
