/*
	...
	Version : 2024
	Generated On : Mon Jan 05 2026 15:04:11 GMT+0530 (India Standard Time)
...
try {
  ...
  var respObj = {
    code: 200,
    msg: Strings.READ_BCSSTEAM_VENDOR_GETALLVENDOR_SUCCESS
  };
  ...
  if (onLoadRes && onLoadRes.override === true) {
    ...
    if (beforeDataRes && beforeDataRes.override === true) {
      ...
      if (params.offset || params.limit)
        countRespObj = dsclientUtil.execute(getAllVendorQueryParams, "BCSSteam", "BCSSteam_vendor", "count");

      //Sending request to ds client
      respObj = dsclientUtil.execute(params, "BCSSteam", "BCSSteam_vendor", "getAll");
    ...
    switch (respObj.code) {
      case 200:
        ...
        respObj.msg = Strings.READ_BCSSTEAM_VENDORS_GETALLVENDOR_SUCCESS;
        break;
      case 400:
        respObj.msg = Strings.READ_BCSSTEAM_VENDORS_GETALLVENDOR_ERROR;
        if (getAllVendorInterface)
          respObj = getAllVendorInterface.onError(respObj);
