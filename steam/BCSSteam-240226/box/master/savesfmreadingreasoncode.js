/*
	...
	Description : CombineMaster Save Service for sfmReadingReasonCode
...
var saveSfmReadingReasonCodeInterface = require("savesfmreadingreasoncodeinterface.js");
...
try {
  ...
  var onLoadRes = null;
  if (saveSfmReadingReasonCodeInterface && saveSfmReadingReasonCodeInterface.onLoad)
    onLoadRes = saveSfmReadingReasonCodeInterface.onLoad(params);
  ...
  if (onLoadRes && onLoadRes.override === true) {
    if (onLoadRes.resp) {
      if (onLoadRes.resp.code) {
        ...
        if (saveSfmReadingReasonCodeInterface && saveSfmReadingReasonCodeInterface.onError)
          respObj = saveSfmReadingReasonCodeInterface.onError(respObj);
    ...
    if (saveSfmReadingReasonCodeInterface && saveSfmReadingReasonCodeInterface.beforeData)
      beforeDataRes = saveSfmReadingReasonCodeInterface.beforeData(params);
    ...
    if (beforeDataRes && beforeDataRes.override === true) {
      ...
      if (params && params.data) {
        ...
        if (saveSfmReadingReasonCodeInterface && saveSfmReadingReasonCodeInterface.beforeExecute)
          queryParams = saveSfmReadingReasonCodeInterface.beforeExecute(queryParams, "query");
        ...
        if (masterRespObj) {
          ...
          if (masterObj) { //master already has data, new data should be appended
            ...
            if (saveSfmReadingReasonCodeInterface && saveSfmReadingReasonCodeInterface.beforeExecute)
              masterDataStr = saveSfmReadingReasonCodeInterface.beforeExecute(masterDataStr, "update");
            ...
            if (saveSfmReadingReasonCodeInterface && saveSfmReadingReasonCodeInterface.beforeExecute)
              masterDataStr = saveSfmReadingReasonCodeInterface.beforeExecute(masterDataStr, "insert");
    ...
    switch (respObj.code) {
      case 200:
        if (saveSfmReadingReasonCodeInterface && saveSfmReadingReasonCodeInterface.afterData)
          respObj.data = saveSfmReadingReasonCodeInterface.afterData(respObj.data);
      ...
      case 400:
        ...
        if (saveSfmReadingReasonCodeInterface && saveSfmReadingReasonCodeInterface.onError)
          respObj = saveSfmReadingReasonCodeInterface.onError(respObj);
        console.error("Unable to save the 'sfmReadingReasonCode' - " + paramStr);
        break;
      case 403:
        respObj.msg = Strings.ACCESS_DENIED;
        if (saveSfmReadingReasonCodeInterface && saveSfmReadingReasonCodeInterface.onError)
          respObj = saveSfmReadingReasonCodeInterface.onError(respObj);
        console.error("User access denied when saving the 'sfmReadingReasonCode' - " + paramStr);
        break;
      case 500:
        respObj.msg = Strings.SERVER_ERROR;
        if (saveSfmReadingReasonCodeInterface && saveSfmReadingReasonCodeInterface.onError)
          respObj = saveSfmReadingReasonCodeInterface.onError(respObj);
        console.error("Unexpected server error when saving the 'sfmReadingReasonCode' - " + paramStr);
        break;
    }
  ...
  if (saveSfmReadingReasonCodeInterface && saveSfmReadingReasonCodeInterface.onError)
    errorRespObj = saveSfmReadingReasonCodeInterface.onError(errorRespObj);
  console.error("Unexpected server error when saving the sfmReadingReasonCode - " + paramStr + "-" + errorRespObj.message);
