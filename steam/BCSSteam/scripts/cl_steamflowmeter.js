/*
	...
	Version : 2024
	Generated On : Wed Mar 25 2026 11:33:42 GMT+0530 (India Standard Time)
    ...
    return function(respObj) {
      ...
      if (respObj.code == 200) {
        ...
        if (undefined && dataSources.getAllVendorsWithoutLimit && dataSources.getAllVendorsWithoutLimit.length > 1) {
          dataSources.getAllVendorsWithoutLimit = clCommon.sort(dataSources.getAllVendorsWithoutLimit, "name"); //Sort alphabetically
        }
        ...
        for (var t = 0; t < dataSources.getAllVendorsWithoutLimit.length; t++) {
          try {
            ...
            dataSources.getAllVendorsWithoutLimit[t].name = scrypto.decrypt(dataSources.getAllVendorsWithoutLimit[t].name);
          } catch (e) {
            //ignore old unencrypted data
            dataSources.getAllVendorsWithoutLimit[t].name = dataSources.getAllVendorsWithoutLimit[t].name;
          }
...
function onRowClick(e) {
  ...
  if (!selectedRow) { //executes when the row is clicked for the first time
    ...
    var vendorArr = dataSources.getAllVendorsWithoutLimit;
    for (var i = 0; i < vendorArr.length; i++) {
      var obj = vendorArr[i];
      if (rowData.vendor_id == obj._sid) {
        steamFlowMeterVendor_id.value = obj.name ? obj.name : "";
        break;
      }
    }
    ...
    var workingPrincipleArr = dataSources.getWorkingPrinciple;
    ...
    var sizeArr = dataSources.getSize;
    ...
    var inputPowerArr = dataSources.getInputPower;
    ...
    var outputSignalArr = dataSources.getOutputSignal;
...
function onFieldChange(e) {
  ...
  if (changedField.id == "steamFlowMeterVendor_id") {
    var rawVal = steamFlowMeterVendor_id.getAttribute("Vendor_id");
    var sourceArr = dataSources.getAllVendorsWithoutLimit;
    if (sourceArr) {
      var item = sourceArr.find(function(x) {
        return x._sid == rawVal;
      });
      steamFlowMeterVendor_id.value = item ? item.name : "";
    }
  }

  if (changedField.id == "steamFlowMeterWorking_principle_id") {
    var rawVal = steamFlowMeterWorking_principle_id.getAttribute("Working_principle_id");
    var sourceArr = dataSources.getWorkingPrinciple;
    if (sourceArr) {
      var item = sourceArr.find(function(x) {
        return x.id == rawVal;
      });
      steamFlowMeterWorking_principle_id.value = item ? item.working_principle : "";
    }
  }

  if (changedField.id == "steamFlowMeterSize_id") {
    var rawVal = steamFlowMeterSize_id.getAttribute("Size_id");
    var sourceArr = dataSources.getSize;
    if (sourceArr) {
      var item = sourceArr.find(function(x) {
        return x.id == rawVal;
      });
      steamFlowMeterSize_id.value = item ? item.size : "";
    }
  }

  if (changedField.id == "steamFlowMeterInput_power_id") {
    var rawVal = steamFlowMeterInput_power_id.getAttribute("Input_power_id");
    var sourceArr = dataSources.getInputPower;
    if (sourceArr) {
      var item = sourceArr.find(function(x) {
        return x.id == rawVal;
      });
      steamFlowMeterInput_power_id.value = item ? item.input_power : "";
    }
  }

  if (changedField.id == "steamFlowMeterOutput_signal_id") {
    var rawVal = steamFlowMeterOutput_signal_id.getAttribute("Output_signal_id");
    var sourceArr = dataSources.getOutputSignal;
    if (sourceArr) {
      var item = sourceArr.find(function(x) {
        return x.id == rawVal;
      });
      steamFlowMeterOutput_signal_id.value = item ? item.output_signal : "";
    }
  }
...
function onVendor_idZoomBtn(e) {
  ...
  for (var item of dataSources.getAllVendorsWithoutLimit) {
    ...
    if (objectiveIds.some(id => id == item._sid)) {
      checked = "checked";
    } else if (rowData && rowData.vendor_id == item._sid && objectiveIds.length === 0) {
      // Fallback to rowData if input is empty but row has data
      checked = "checked";
    }

    vendor_idArr.push({
      "vendor_idName": '<label for="' + item._sid + '">' + item.name + '</label>',
...
function onRelateVendor_idBtn(e) {
  ...
  var selectedObjs = document.querySelectorAll('input[name="vendor_idName"]:checked');
  ...
  selectedObjs.forEach(function(el) {
    var objective = JSON.parse(el.getAttribute("vendor_idName").replaceAll('$DQUOTE$', '"'));
  ...
  steamFlowMeterVendor_id.value = selectedNames[0];
  steamFlowMeterVendor_id.setAttribute("Vendor_id", selectedIds[0]);
  selectedVendor_idId = selectedIds[0];
...
function onWorking_principle_idZoomBtn(e) {
  ...
  for (var item of dataSources.getWorkingPrinciple) {
    ...
    if (objectiveIds.some(id => id == item.id)) {
      checked = "checked";
    } else if (rowData && rowData.working_principle_id == item.id && objectiveIds.length === 0) {
      // Fallback to rowData if input is empty but row has data
      checked = "checked";
    }
...
function onRelateWorking_principle_idBtn(e) {
  // Select all checked inputs
  var selectedObjs = document.querySelectorAll('input[name="working_principle_idName"]:checked');
  ...
  selectedObjs.forEach(function(el) {
    var objective = JSON.parse(el.getAttribute("working_principle_idName").replaceAll('$DQUOTE$', '"'));
    var val = objective.id || "";
    var disp = objective.working_principle || "";
  ...
  // Radio: Store single value in attribute (0 index)
  steamFlowMeterWorking_principle_id.value = selectedNames[0];
  steamFlowMeterWorking_principle_id.setAttribute("Working_principle_id", selectedIds[0]);
  selectedWorking_principle_idId = selectedIds[0];
...
function onSize_idZoomBtn(e) {
  ...
  for (var item of dataSources.getSize) {
    ...
    if (objectiveIds.some(id => id == item.id)) {
      checked = "checked";
    } else if (rowData && rowData.size_id == item.id && objectiveIds.length === 0) {
      // Fallback to rowData if input is empty but row has data
      checked = "checked";
    }
...
function onRelateSize_idBtn(e) {
  // Select all checked inputs
  var selectedObjs = document.querySelectorAll('input[name="size_idName"]:checked');
  ...
  selectedObjs.forEach(function(el) {
    var objective = JSON.parse(el.getAttribute("size_idName").replaceAll('$DQUOTE$', '"'));
    var val = objective.id || "";
    var disp = objective.size || "";
  ...
  // Radio: Store single value in attribute (0 index)
  steamFlowMeterSize_id.value = selectedNames[0];
  steamFlowMeterSize_id.setAttribute("Size_id", selectedIds[0]);
  selectedSize_idId = selectedIds[0];
...
function onInput_power_idZoomBtn(e) {
  ...
  for (var item of dataSources.getInputPower) {
    ...
    if (objectiveIds.some(id => id == item.id)) {
      checked = "checked";
    } else if (rowData && rowData.input_power_id == item.id && objectiveIds.length === 0) {
      // Fallback to rowData if input is empty but row has data
      checked = "checked";
    }
...
function onRelateInput_power_idBtn(e) {
  // Select all checked inputs
  var selectedObjs = document.querySelectorAll('input[name="input_power_idName"]:checked');
  ...
  selectedObjs.forEach(function(el) {
    var objective = JSON.parse(el.getAttribute("input_power_idName").replaceAll('$DQUOTE$', '"'));
    var val = objective.id || "";
    var disp = objective.input_power || "";
  ...
  // Radio: Store single value in attribute (0 index)
  steamFlowMeterInput_power_id.value = selectedNames[0];
  steamFlowMeterInput_power_id.setAttribute("Input_power_id", selectedIds[0]);
  selectedInput_power_idId = selectedIds[0];
...
function onOutput_signal_idZoomBtn(e) {
  ...
  for (var item of dataSources.getOutputSignal) {
    ...
    if (objectiveIds.some(id => id == item.id)) {
      checked = "checked";
    } else if (rowData && rowData.output_signal_id == item.id && objectiveIds.length === 0) {
      // Fallback to rowData if input is empty but row has data
      checked = "checked";
    }
...
function onRelateOutput_signal_idBtn(e) {
  // Select all checked inputs
  var selectedObjs = document.querySelectorAll('input[name="output_signal_idName"]:checked');
  ...
  selectedObjs.forEach(function(el) {
    var objective = JSON.parse(el.getAttribute("output_signal_idName").replaceAll('$DQUOTE$', '"'));
    var val = objective.id || "";
    var disp = objective.output_signal || "";
  ...
  // Radio: Store single value in attribute (0 index)
  steamFlowMeterOutput_signal_id.value = selectedNames[0];
  steamFlowMeterOutput_signal_id.setAttribute("Output_signal_id", selectedIds[0]);
  selectedOutput_signal_idId = selectedIds[0];
