/*
	...
	Version : 2024
	Generated On : Thu Apr 09 2026 12:00:14 GMT+0530 (India Standard Time)
...
function renderData(data, type, row, meta) {
  ...
  if (UtilityInterface && UtilityInterface.renderData)
    dataDisplay = UtilityInterface.renderData(dataDisplay, data, type, row, meta);
...
function onChangeOfFilter(e) {
  ...
  clCommon.setCookie("sfmpCode_id", sfmpCodeFilter.value, 10)
  ...
  if (selectedType == 'search') {
    ...
    if (UtilityInterface && UtilityInterface.onChangeFilter)
      onChangeCheck = UtilityInterface.onChangeFilter(changedElement)
  }
}
