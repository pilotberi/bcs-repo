/*
	...
	Version : 2024
	Generated On : Fri Jan 16 2026 10:12:17 GMT+0530 (India Standard Time)
	...
	for (var row = 0; row < sheetData.length; row++) {
		...
		if (rowData[1] && rowData[1].length > 0) {
			...
			if (checkStatus == true) {
				...
				data["reading_reason_code"] = rowData[1] || null;
...
function validate(rowData) {
	...
	if (rowData[1] == null || rowData[1] === '') { //this is to validate reading_reason_code
		s_info(Strings.VALIDATION_ERROR_TITLE, Strings.READINGREASONCODE_INVALID_READING_REASON_CODE, dlgOptions);
		return false;
	}
