/*
	...
	Version : 2024
	Generated On : Wed Mar 25 2026 11:31:57 GMT+0530 (India Standard Time)
...
var sfmConnectivityOptionTable;



var createSfmConnectivityOptionBtn, addSfmConnectivityOptionBtn, cancelBtns, duplicateSfmConnectivityOptionBtn, deleteSfmConnectivityOptionBtn, editSfmConnectivityOptionBtn, importSfmConnectivityOptionBtn, aiAssistantSfmConnectivityOptionBtn;
...
var filterSfmConnectivityOptionBtn, filterActionsSfmConnectivityOptionBtn;
var selectFilters;
...
var sfmConnectivityOptionSfm_connectivity_option, sfmConnectivityOptionSfm_connectivity_description, sfmConnectivityOptionSfm_connectivity_active;
...
function onApplicationReady() {
  ...
  setMenu(document.getElementById('sideMenu'), 'bcssteam_sfmConnectivityOption');
...
function initControls() {
  ...
  formView = document.getElementById('sfmConnectivityOptionDetailsPanel');
  ...
  sfmConnectivityOptionSfm_connectivity_option = document.getElementById('sfmConnectivityOptionSfm_connectivity_option');
  sfmConnectivityOptionSfm_connectivity_description = document.getElementById('sfmConnectivityOptionSfm_connectivity_description');
  sfmConnectivityOptionSfm_connectivity_active = document.getElementById('sfmConnectivityOptionSfm_connectivity_active');
...
function initTable() {
  var dtOpns = { //Funtion to display datatable
    ...
    autoWidth: false,
    columns: [{
      data: 'sfm_connectivity_option',
      'bSortable': true,
      'type': 'sfm_connectivity_option',
      render: renderData,
    }, {
      data: 'sfm_connectivity_description',
      'bSortable': true,
      'type': 'sfm_connectivity_description',
      render: renderData,
    }, {
      data: 'sfm_connectivity_active',
      'bSortable': true,
      'type': 'sfm_connectivity_active',
      render: renderData,
    }],
    "columnDefs": [],
    "orderClasses": false,
  ...
  sfmConnectivityOptionTable = $('#tableHolder').DataTable(dtOpns);


  jQuery.fn.dataTableExt.oSort["sfm_connectivity_option-desc"] = function(x, y) {
  ...
  jQuery.fn.dataTableExt.oSort["sfm_connectivity_option-asc"] = function(x, y) {
    //return getRank(x) > getRank(y);
    var tElem = document.createElement('div');
    tElem.innerHTML = x + y;
    var sX = parseInt(tElem.firstChild.getAttribute("ddval"));
  ...
  jQuery.fn.dataTableExt.oSort["sfm_connectivity_description-desc"] = function(x, y) {
    //return getRank(x) < getRank(y);
    var tElem = document.createElement('div');
    tElem.innerHTML = x + y;
    var sX = parseInt(tElem.firstChild.getAttribute("ddval"));
  ...
  jQuery.fn.dataTableExt.oSort["sfm_connectivity_description-asc"] = function(x, y) {
    //return getRank(x) > getRank(y);
    var tElem = document.createElement('div');
    tElem.innerHTML = x + y;
    var sX = parseInt(tElem.firstChild.getAttribute("ddval"));
  ...
  jQuery.fn.dataTableExt.oSort["sfm_connectivity_active-desc"] = function(x, y) {
    //return getRank(x) < getRank(y);
    var tElem = document.createElement('div');
    tElem.innerHTML = x + y;
    var sX = parseInt(tElem.firstChild.getAttribute("ddval"));
  ...
  jQuery.fn.dataTableExt.oSort["sfm_connectivity_active-asc"] = function(x, y) {
    //return getRank(x) > getRank(y);
    var tElem = document.createElement('div');
    tElem.innerHTML = x + y;
    var sX = parseInt(tElem.firstChild.getAttribute("ddval"));
...
function renderData(data, type, row, meta) {
  var dataDisplay;
  if (SfmConnectivityOptionInterface && SfmConnectivityOptionInterface.renderData)
    dataDisplay = SfmConnectivityOptionInterface.renderData(data, type, row, meta);
...
function setTableHeightOnResize() {
  ...
  sfmConnectivityOptionTable.columns.adjust();
}
...
function registerEventListeners() {
  ...
  filterSfmConnectivityOptionBtn = document.getElementById('filterSfmConnectivityOptionBtn');
  filterSfmConnectivityOptionBtn.addEventListener('click', onFilterSfmConnectivityOptionBtnClick);
  ...
  filterActionsSfmConnectivityOptionBtn = document.getElementById('filterActionsSfmConnectivityOptionBtn');
  filterActionsSfmConnectivityOptionBtn.addEventListener('click', onFilterSfmConnectivityOptionBtnClick);

  createSfmConnectivityOptionBtn = document.getElementById('createSfmConnectivityOptionBtn');
  createSfmConnectivityOptionBtn.addEventListener('click', onCreateSfmConnectivityOptionBtnClick);

  editSfmConnectivityOptionBtn = document.getElementById('updateSfmConnectivityOptionBtn');
  editSfmConnectivityOptionBtn.addEventListener('click', onUpdateSfmConnectivityOptionBtnClick);

  addSfmConnectivityOptionBtn = document.getElementById('addSfmConnectivityOptionBtn');
  addSfmConnectivityOptionBtn.addEventListener('click', onAddSfmConnectivityOptionBtnClick);



  if (clCommon.isMobile()) {
    deleteSfmConnectivityOptionBtn = document.getElementById('deleteSfmConnectivityOptionMobBtn');
    clCommon.hide(document.getElementById('deleteSfmConnectivityOptionBtn'));
  } else {
    deleteSfmConnectivityOptionBtn = document.getElementById('deleteSfmConnectivityOptionBtn');
  }
  deleteSfmConnectivityOptionBtn.addEventListener('click', onDeleteSfmConnectivityOptionBtnClick);
  ...
  sfmConnectivityOptionSfm_connectivity_option.addEventListener('change', onFieldChange);
  sfmConnectivityOptionSfm_connectivity_option.addEventListener('focus', onFieldFocus);
  sfmConnectivityOptionSfm_connectivity_option.addEventListener('blur', onFieldChange);
  sfmConnectivityOptionSfm_connectivity_description.addEventListener('change', onFieldChange);
  sfmConnectivityOptionSfm_connectivity_description.addEventListener('focus', onFieldFocus);
  sfmConnectivityOptionSfm_connectivity_description.addEventListener('blur', onFieldChange);
  sfmConnectivityOptionSfm_connectivity_active.addEventListener('change', onFieldChange);
  sfmConnectivityOptionSfm_connectivity_active.addEventListener('focus', onFieldFocus);
  sfmConnectivityOptionSfm_connectivity_active.addEventListener('blur', onFieldChange);
...
function toggleFullview(forceState) {
  ...
  if (shouldBeFull) {
    ...
    if (sfmConnectivityOptionTable) {
      sfmConnectivityOptionTable.rows().invalidate().draw(false);
      resizeTable();
    }
  } else {
    // EXIT Full View
...
function onFilterSfmConnectivityOptionBtnClick(e) {
  clCommon.show(selectFilters);
...
function openFilterPopup(event) {
  ...
  if (clCommon.isMobile()) {
    if (event.target.id === 'filterSfmConnectivityOptionBtn') {
      activateTab('nav-filter', 'nav-action');
    } else if (event.target.id === 'filterActionsSfmConnectivityOptionBtn') {
...
function onUser(resp) {
  ...
  clCommon.initLanguage(userObj.realm_lang, function() {
    ...
    if (typeof SfmConnectivityOptionInterface === 'undefined')
      SfmConnectivityOptionInterface = null;

    if (SfmConnectivityOptionInterface && SfmConnectivityOptionInterface.onLoad)
      SfmConnectivityOptionInterface.onLoad();
...
function loadLimFunction(lim) {
  ...
  clCommon.setCookie("SfmConnectivityOptionOffset", offset, 10);
  clCommon.setCookie("SfmConnectivityOptionLimit", limit, 10);
...
function onFormBackBtnClick(e) {
  ...
  if (isFullCookie === "true") {
    ...
    deleteSfmConnectivityOptionBtn.classList.add('disabled');
  }
...
function loadData() {
  ...
  var beforeLoad = true;
  if (SfmConnectivityOptionInterface && SfmConnectivityOptionInterface.onBeforeLoad)
    beforeLoad = SfmConnectivityOptionInterface.onBeforeLoad(dataSources);

  if (beforeLoad == false) {
    return
  }
  svcCount = 0;
  loadMainSfmConnectivityOptionData();

  onAfterLoadFunction();
}

function loadMainSfmConnectivityOptionData() {
  clCommon.showLoader('dataProgress');
  checkAndLoadData();
  hideLoaderFn();
}
...
function onAfterLoadFunction() {
  if (SfmConnectivityOptionInterface && SfmConnectivityOptionInterface.onAfterLoad)
    SfmConnectivityOptionInterface.onAfterLoad(dataSources);
...
function checkAndLoadData() {
  var limitCookie = clCommon.getCookie("SfmConnectivityOptionLimit");
  var offsetCookie = clCommon.getCookie("SfmConnectivityOptionOffset");
...
function loadSfmConnectivityOptionData() {
  sfmConnectivityOptionTable.clear().draw();
  ...
  if (SfmConnectivityOptionInterface && SfmConnectivityOptionInterface.onBeforeData)
    onBeforeData = SfmConnectivityOptionInterface.onBeforeData(params, dataSources);
  ...
  if (onBeforeData) {
    params.push(function(resultObj) {
      ...
      if (resultObj.code == 200) { //On success response
        ...
        if (SfmConnectivityOptionInterface && SfmConnectivityOptionInterface.onAfterData)
          dataArr = SfmConnectivityOptionInterface.onAfterData(isSuccessful, dataArr, dataSources);
        ...
        s_error(Strings.ERROR, Strings.ERROR_LOAD_SFMCONNECTIVITYOPTION, dlgOptions);
      }
    });
    Service.getAllConnectOption.apply(this, params);
  }
  if (clCommon.isMobile()) {
    hideForm();
  }
...
function loadChunk(dataArr) {
  ...
  sfmConnectivityOptionTable.rows.add(chunk).draw(); // 'false' to not reset paging each time
...
function onChangeOfFilter(e) {
  ...
  if (selectedType == 'search') {
    ...
    if (SfmConnectivityOptionInterface && SfmConnectivityOptionInterface.onSearchChangeFilter) {
      onSearchCheck = SfmConnectivityOptionInterface.onSearchChangeFilter(e);
    }

  } else {
    var onChangeCheck = true;
    if (SfmConnectivityOptionInterface && SfmConnectivityOptionInterface.onChangeFilter)
      onChangeCheck = SfmConnectivityOptionInterface.onChangeFilter(e)
  }
}
...
function onChangeOfActionSelect(val) {
  ...
  var returnData = true;
  if (SfmConnectivityOptionInterface && SfmConnectivityOptionInterface.onChangeOfActionSelect)
    returnData = SfmConnectivityOptionInterface.onChangeOfActionSelect(changedAction, dataSources);
  if (returnData == false) {
    return;
  }
}
...
function onCreateSfmConnectivityOptionBtnClick(e) {
  e.preventDefault();

  var sfmConnectivityOptionObj = {};

  if (sfmConnectivityOptionSfm_connectivity_option.value != "") {
    sfmConnectivityOptionObj.sfm_connectivity_option = sfmConnectivityOptionSfm_connectivity_option.value;
  } else {
    sfmConnectivityOptionObj.sfm_connectivity_option = null;
  }
  if (sfmConnectivityOptionSfm_connectivity_description.value != "") {
    sfmConnectivityOptionObj.sfm_connectivity_description = sfmConnectivityOptionSfm_connectivity_description.value;
  } else {
    sfmConnectivityOptionObj.sfm_connectivity_description = null;
  }
  sfmConnectivityOptionObj.sfm_connectivity_active = sfmConnectivityOptionSfm_connectivity_active.checked;
  var date = new Date();
  sfmConnectivityOptionObj.created_by = userObj.username;
  sfmConnectivityOptionObj.created_on = date.getTime();
  sfmConnectivityOptionObj.modified_on = date.getTime();
  sfmConnectivityOptionObj.modified_by = userObj.username;

  //Validate the sfmConnectivityOption object
  var checkSfmConnectivityOption = validate(sfmConnectivityOptionObj);

  //In validation is successfull
  if (checkSfmConnectivityOption == true) {





    if (SfmConnectivityOptionInterface && SfmConnectivityOptionInterface.onBeforeCreate)
      sfmConnectivityOptionObj = SfmConnectivityOptionInterface.onBeforeCreate(sfmConnectivityOptionObj, dataSources);
    if (sfmConnectivityOptionObj == false) {
      return;
    }


    clCommon.showLoader("createProgress");
    clCommon.disable(createSfmConnectivityOptionBtn);


    Service.createConnectOption(sfmConnectivityOptionObj, function(resultObj) {
      if (resultObj.code == 200) { //on success response
        clCommon.hideLoader("createProgress");
        clCommon.enable(createSfmConnectivityOptionBtn);
        s_toast(Strings.CREATE_SFMCONNECTIVITYOPTION_TOAST_SUCCESS);
        var isSuccessful = true;


        if (SfmConnectivityOptionInterface && SfmConnectivityOptionInterface.onAfterCreate)
          sfmConnectivityOptionObj = SfmConnectivityOptionInterface.onAfterCreate(isSuccessful, resultObj.data, dataSources);

        if (sfmConnectivityOptionObj == false) {
          return;
        }

        clCommon.setCookie("sfmConnectivityOption_id", resultObj.data._sid, 10);
        ...
        s_error(Strings.SFMCONNECTIVITYOPTION_ERROR_TITLE, Strings.CREATE_SFMCONNECTIVITYOPTION_ERROR, dlgOptions);
      }
    });
  }
}
...
function onRowClick(e) {
  ...
  if (!selectedRow) { //executes when the row is clicked for the first time
    ...
    deleteSfmConnectivityOptionBtn.classList.remove('disabled');


    clCommon.hide(createBtn);
    clCommon.show(updateBtn);

    clCommon.focus(sfmConnectivityOptionSfm_connectivity_option);
    selectedRow = this;

    rowData = sfmConnectivityOptionTable.row(selectedRow).data();



    if (SfmConnectivityOptionInterface && SfmConnectivityOptionInterface.onRowItemClick)
      rowData = SfmConnectivityOptionInterface.onRowItemClick(rowData);
...
function displayForm(rowData) {
  ...
  sfmConnectivityOptionSfm_connectivity_option.value = rowData.sfm_connectivity_option;
  sfmConnectivityOptionSfm_connectivity_description.value = rowData.sfm_connectivity_description;
  sfmConnectivityOptionSfm_connectivity_active.checked = rowData.sfm_connectivity_active;



  if (SfmConnectivityOptionInterface && SfmConnectivityOptionInterface.onDisplayForm)
    rowData = SfmConnectivityOptionInterface.onDisplayForm(rowData);

}


function onUpdateSfmConnectivityOptionBtnClick(e) {
  e.preventDefault();
  ...
  sfmConnectivityOptionObj._sid = rowData._sid;
  var date = new Date();
  sfmConnectivityOptionObj.modified_on = date.getTime();
  sfmConnectivityOptionObj.modified_by = userObj.username;
  sfmConnectivityOptionObj.created_by = rowData.created_by ? rowData.created_by : userObj.username;
  sfmConnectivityOptionObj.created_on = rowData.created_on ? rowData.created_on : null;
  ...
  if (checkSfmConnectivityOption == true) {
    ...
    if (SfmConnectivityOptionInterface && SfmConnectivityOptionInterface.onBeforeUpdate)
      sfmConnectivityOptionObj = SfmConnectivityOptionInterface.onBeforeUpdate(sfmConnectivityOptionObj, dataSources);
    if (sfmConnectivityOptionObj == false) {
      return;
    }
    ...
    clCommon.disable(updateSfmConnectivityOptionBtn);

    Service.updateConnectOption(sfmConnectivityOptionObj, function(resultObj) {
      if (resultObj.code == 200) { //on success response
        clCommon.hideLoader("updateProgress");
        clCommon.enable(updateSfmConnectivityOptionBtn);
        s_toast(Strings.UPDATE_SFMCONNECTIVITYOPTION_TOAST_SUCCESS);

        var isSuccessful = true;


        if (SfmConnectivityOptionInterface && SfmConnectivityOptionInterface.onAfterUpdate)
          sfmConnectivityOptionObj = SfmConnectivityOptionInterface.onAfterUpdate(isSuccessful, resultObj.data, dataSources);
        if (sfmConnectivityOptionObj == false) {
          return;
        }
        ...
        s_error(Strings.SFMCONNECTIVITYOPTION_ERROR_TITLE, Strings.UPDATE_SFMCONNECTIVITYOPTION_ERROR, dlgOptions);
      }
    });
  }
}
...
function updateRowBySid(sid, updatedData) {
  ...
  var rowIndexes = sfmConnectivityOptionTable.rows().indexes().toArray();
  var foundIndex = -1;

  // Manual search to be precise
  for (var i = 0; i < rowIndexes.length; i++) {
    var d = sfmConnectivityOptionTable.row(rowIndexes[i]).data();
    if (d && d._sid === sid) {
  ...
  if (foundIndex !== -1) {
    ...
    sfmConnectivityOptionTable.row(foundIndex).data(updatedData);

    // 2. Invalidate the row to force re-render (Runs renderData again)
    sfmConnectivityOptionTable.row(foundIndex).invalidate().draw(false);
...
function selectRowBySid(sid) {
  ...
  var table = sfmConnectivityOptionTable;
...
function onAddSfmConnectivityOptionBtnClick(e) {
  e.preventDefault();
  clearForm();
...
function clearForm() {
  var defaultObj = {
    "sfm_connectivity_option": "",
    "sfm_connectivity_description": "",
    "sfm_connectivity_active": false
  };
  ...
  if (SfmConnectivityOptionInterface && SfmConnectivityOptionInterface.onClearForm) {
    var modDefaultObj = SfmConnectivityOptionInterface.onClearForm(defaultObj, dataSources);
...
function onDeleteSfmConnectivityOptionBtnClick() {
  var clArr = deleteSfmConnectivityOptionBtn.classList;
  if (clArr.contains('disabled') == false)
    s_confirm(Strings.CONFIRM, Strings.SFMCONNECTIVITYOPTION_DELETE_CONFIRM + " - " + rowData.sfm_connectivity_option + Strings.DELETE_TITLE_SFMCONNECTIVITYOPTION + " ?", { //Confirmation with user
      STR_YES: dlgOptions.STR_YES,
      STR_NO: dlgOptions.STR_NO,
      onYes: function() { //on approval
        clCommon.showLoader("removeProgress");

        if (SfmConnectivityOptionInterface && SfmConnectivityOptionInterface.onBeforeDelete)
          rowData = SfmConnectivityOptionInterface.onBeforeDelete(rowData, dataSources);
        if (rowData == false) {
        ...
        Service.deleteConnectOption(rowData._sid, function(resultObj) {
          if (resultObj.code == 200) { //on Success response
            clCommon.hideLoader("removeProgress");
            ...
            if (SfmConnectivityOptionInterface && SfmConnectivityOptionInterface.onAfterDelete)
              afterDelete = SfmConnectivityOptionInterface.onAfterDelete(isSuccessful, resultObj, dataSources);
            ...
            s_toast(Strings.DELETE_SFMCONNECTIVITYOPTION_TOAST_SUCCESS);
          } else { //On Error response
            var isSuccessful = false;
            ...
            s_error(Strings.SFMCONNECTIVITYOPTION_ERROR_TITLE, Strings.DELETE_SFMCONNECTIVITYOPTION_ERROR, dlgOptions);
            clCommon.hideLoader("removeProgress");
          }
        });
      }
...
function removeRowBySid(sid) {
  ...
  sfmConnectivityOptionTable.rows(function(idx, data, node) {
    return data._sid === sid; // Find row where _sid matches
  }).remove().draw(); // Remove and redraw the table

  if (sfmConnectivityOptionTable.data().any()) {
    // Select the first row in the current page
    var firstRowNode = sfmConnectivityOptionTable.row(':eq(0)', {
      page: 'current'
    }).node();
    if (firstRowNode) {


      clCommon.enable(deleteSfmConnectivityOptionBtn);
...
function onFieldFocus(e) {
  ...
  if (SfmConnectivityOptionInterface && SfmConnectivityOptionInterface.onFieldFocus)
    var returnData = SfmConnectivityOptionInterface.onFieldFocus(focusedField, dataSources);
}
  ...
  if (dependentFieldArr.length > 0) {
    for (var idx = 0; idx < dependentFieldArr.length; idx++) {
      ...
      if (dataSrcFunction) {
        ...
        if (SfmConnectivityOptionInterface && SfmConnectivityOptionInterface.onFieldChange)
          var returnData = SfmConnectivityOptionInterface.onFieldChange(changedField, dataSources);
      }
    }
  } else {
    if (SfmConnectivityOptionInterface && SfmConnectivityOptionInterface.onFieldChange)
...
function validate(sfmConnectivityOptionObj) {

  if (!sfmConnectivityOptionObj.sfm_connectivity_option) {
    s_info(Strings.VALIDATION_ERROR_TITLE, Strings.SFMCONNECTIVITYOPTION_INVALID_SFM_CONNECTIVITY_OPTION, dlgOptions);
    return false;
  }

  if (!sfmConnectivityOptionObj.sfm_connectivity_description) {
    s_info(Strings.VALIDATION_ERROR_TITLE, Strings.SFMCONNECTIVITYOPTION_INVALID_SFM_CONNECTIVITY_DESCRIPTION, dlgOptions);
    return false;
  }
...
function onToolBarBtnClick(e) {
  ...
  var clickedBtn = this;
  var returnData = true;
  if (SfmConnectivityOptionInterface && SfmConnectivityOptionInterface.onToolBarBtnClick)
    returnData = SfmConnectivityOptionInterface.onToolBarBtnClick(clickedBtn, dataSources);
  if (returnData === false) {
    return;
  } else {
    var clArr;
...
function onLookupAddBtnClick(e) {
  ...
  var clickedBtn = this;
  var returnData = true;
  if (SfmConnectivityOptionInterface && SfmConnectivityOptionInterface.onLookupAddBtnClick)
    returnData = SfmConnectivityOptionInterface.onLookupAddBtnClick(clickedBtn.getAttribute('data-lookup-add'), clickedBtn, dataSources);
  if (returnData === false) {
    return;
  }
}