/*
	...
	Version : 2024
	Generated On : Mon Mar 16 2026 12:24:32 GMT+0530 (India Standard Time)
...
function onSaveSizeBtnClick(e) {
  ...
  var checkStatus = validate(sizeArr);
...
function validate(dataArr) {
  ...
  dataArr.forEach(function(sizeObj) {
    var errorStr = "";
    var rowNum = sizeObj._rowNum;

    function addError(error) {
      errorStr += error + "<br>";
    }

    var rowTitle = sizeObj.name || sizeObj.undefined || sizeObj.id || "-";

    if (SizeInterface && SizeInterface.getRowTitle) {
      var customTitle = SizeInterface.getRowTitle(sizeObj, dataSources);
    ...
    if (sizeObj.size == null || sizeObj.size === '') {
      addError(Strings.SIZE_INVALID_SIZE);
    }

    // C. External Interface Validation
    if (SizeInterface && SizeInterface.addValidation) {
      var extErr = SizeInterface.addValidation(sizeObj, dataSources);
  ...
  if (validateError.length > 0) {
    ...
    var promptTitle = (typeof Strings !== 'undefined' && Strings.VALIDATE_SIZE_PROMPT) ? Strings.VALIDATE_SIZE_PROMPT : "Validation Errors";
    var objTitle = (typeof Strings !== 'undefined' && Strings.SIZE_TITLE) ? Strings.SIZE_TITLE : "Size";
