/*
	...
	Version : 2024
	Generated On : Wed Mar 25 2026 11:32:24 GMT+0530 (India Standard Time)
...
var vendorBusiness_partner_id, vendorBusiness_partner_short_name, vendorIsactive;
...
function initControls() {
  ...
  vendorBusiness_partner_short_name = document.getElementById('vendorBusiness_partner_short_name');
...
function registerEventListeners() {
  ...
  vendorBusiness_partner_short_name.addEventListener('change', onFieldChange);
  vendorBusiness_partner_short_name.addEventListener('focus', onFieldFocus);
  vendorBusiness_partner_short_name.addEventListener('blur', onFieldChange);
...
function onCreateVendorBtnClick(e) {
  ...
  if (vendorBusiness_partner_short_name.value != "") {
    vendorObj.business_partner_short_name = vendorBusiness_partner_short_name.value;
  } else {
    vendorObj.business_partner_short_name = null;
  }
...
function displayForm(rowData) {
  ...
  vendorBusiness_partner_id.dispatchEvent(new Event("change"));
  vendorBusiness_partner_short_name.value = rowData.business_partner_short_name;
...
function onFieldChange(e) {
  ...
  if (changedField.id == "vendorBusiness_partner_id") {
    var rawVal = vendorBusiness_partner_id.getAttribute("Business_partner_id");
    var sourceArr = dataSources.getAllBusinessPartner;
    if (sourceArr) {
      var item = sourceArr.find(function(x) {
        return x._sid == rawVal;
      });
      vendorBusiness_partner_id.value = item ? item.name : "";
    }
  }
...
function validate(vendorObj) {
  ...
  if (!vendorObj.business_partner_short_name) {
    s_info(Strings.VALIDATION_ERROR_TITLE, Strings.VENDOR_INVALID_BUSINESS_PARTNER_SHORT_NAME, dlgOptions);
    return false;
  }
...
function onRelateBusiness_partner_idBtn(e) {
  ...
  vendorBusiness_partner_id.value = selectedNames[0];
  vendorBusiness_partner_id.setAttribute("Business_partner_id", selectedIds[0]);
