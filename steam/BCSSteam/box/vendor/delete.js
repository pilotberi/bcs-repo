...
try {
  ...
  var respObj = {
    code: 200,
    msg: Strings.DELETE_BCSSTEAM_VENDOR_SUCCESS
  };
  ...
  if (deleteVendorInterface && onLoadRes && onLoadRes.override === true) {
    ...
    if (deleteVendorInterface && beforeDataRes && beforeDataRes.override === true) {
      ...
      if (params && params.id) {
        ...
        //Sending request to ds client
        respObj = dsclientUtil.execute(params, "BCSSteam", "BCSSteam_vendor", "delete");
      } else {
        respObj.code = 400;
        respObj.msg = Strings.DELETE_BCSSTEAM_VENDOR_ERROR;
      }
    }
    ...
    switch (respObj.code) {
      case 200:
        ...
        respObj.msg = Strings.DELETE_BCSSTEAM_VENDOR_SUCCESS;
        break;
      case 400:
        respObj.msg = Strings.DELETE_BCSSTEAM_VENDOR_ERROR;
        if (deleteVendorInterface)
