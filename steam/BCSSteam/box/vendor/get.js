...
var getVendorInterface = require("getinterface.js");
...
try {
  ...
  var respObj = {
    code: 200,
    msg: Strings.READ_BCSSTEAM_VENDOR_GETVENDOR_SUCCESS
  };
  ...
  if (onLoadRes && onLoadRes.override === true) {
    ...
    if (beforeDataRes && beforeDataRes.override === true) {
      ...
      if (params && params.id) {
        ...
        if (getVendorInterface) {
          getParams = getVendorInterface.beforeExecute(getParams);
        }
        //Sending request to ds client
        respObj = dsclientUtil.execute(getParams, "BCSSteam", "BCSSteam_vendor", "get");
      } else {
        respObj.code = 400;
        respObj.msg = Strings.READ_BCSSTEAM_VENDOR_ERROR;
      }
    }
    ...
    switch (respObj.code) {
      case 200:
        ...
        respObj.msg = Strings.READ_BCSSTEAM_VENDOR_GETVENDOR_SUCCESS;
        break;
      case 400:
        respObj.msg = Strings.READ_BCSSTEAM_VENDOR_GETVENDOR_ERROR;
        if (getVendorInterface)
          respObj = getVendorInterface.onError(respObj);
