/*
	...
	Description : CombineMaster Save Service for workingPrinciple
...
var saveWorkingPrincipleInterface = require("saveworkingprincipleinterface.js");
...
try {
  ...
  var onLoadRes = null;
  if (saveWorkingPrincipleInterface && saveWorkingPrincipleInterface.onLoad)
    onLoadRes = saveWorkingPrincipleInterface.onLoad(params);
  ...
  if (onLoadRes && onLoadRes.override === true) {
    if (onLoadRes.resp) {
      if (onLoadRes.resp.code) {
        ...
        if (saveWorkingPrincipleInterface && saveWorkingPrincipleInterface.onError)
          respObj = saveWorkingPrincipleInterface.onError(respObj);
    ...
    if (saveWorkingPrincipleInterface && saveWorkingPrincipleInterface.beforeData)
      beforeDataRes = saveWorkingPrincipleInterface.beforeData(params);
    ...
    if (beforeDataRes && beforeDataRes.override === true) {
      ...
      if (params && params.data) {
        ...
        if (saveWorkingPrincipleInterface && saveWorkingPrincipleInterface.beforeExecute)
          queryParams = saveWorkingPrincipleInterface.beforeExecute(queryParams, "query");
        ...
        if (masterRespObj) {
          ...
          if (masterObj) { //master already has data, new data should be appended
            ...
            if (saveWorkingPrincipleInterface && saveWorkingPrincipleInterface.beforeExecute)
              masterDataStr = saveWorkingPrincipleInterface.beforeExecute(masterDataStr, "update");
            ...
            if (saveWorkingPrincipleInterface && saveWorkingPrincipleInterface.beforeExecute)
              masterDataStr = saveWorkingPrincipleInterface.beforeExecute(masterDataStr, "insert");
    ...
    switch (respObj.code) {
      case 200:
        if (saveWorkingPrincipleInterface && saveWorkingPrincipleInterface.afterData)
          respObj.data = saveWorkingPrincipleInterface.afterData(respObj.data);
      ...
      case 400:
        ...
        if (saveWorkingPrincipleInterface && saveWorkingPrincipleInterface.onError)
          respObj = saveWorkingPrincipleInterface.onError(respObj);
        console.error("Unable to save the 'workingprinciple' - " + paramStr);
        break;
      case 403:
        respObj.msg = Strings.ACCESS_DENIED;
        if (saveWorkingPrincipleInterface && saveWorkingPrincipleInterface.onError)
          respObj = saveWorkingPrincipleInterface.onError(respObj);
        console.error("User access denied when saving the 'workingprinciple' - " + paramStr);
        break;
      case 500:
        respObj.msg = Strings.SERVER_ERROR;
        if (saveWorkingPrincipleInterface && saveWorkingPrincipleInterface.onError)
          respObj = saveWorkingPrincipleInterface.onError(respObj);
        console.error("Unexpected server error when saving the 'workingprinciple' - " + paramStr);
        break;
    }
  ...
  if (saveWorkingPrincipleInterface && saveWorkingPrincipleInterface.onError)
    errorRespObj = saveWorkingPrincipleInterface.onError(errorRespObj);
  console.error("Unexpected server error when saving the workingprinciple - " + paramStr + "-" + errorRespObj.message);
