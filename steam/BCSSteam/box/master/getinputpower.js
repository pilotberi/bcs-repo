/*
	...
	Description : Get Service for inputPower
...
var getInputPowerInterface = require("getinputpowerinterface.js");
...
function setDefaultMasterData(defaultArr) {
  ...
  var respObj = {
    code: 200,
    msg: Strings.UPDATE_INPUTPOWER_SUCCESS
  };
  ...
  if (getInputPowerInterface && getInputPowerInterface.beforeExecute)
    queryParams = getInputPowerInterface.beforeExecute(queryParams, "query");
  ...
  if (masterRespObj) {
    ...
    if (masterObj) { //master already has data, new data should be appended
      ...
      if (getInputPowerInterface && getInputPowerInterface.beforeExecute)
        masterDataStr = getInputPowerInterface.beforeExecute(masterDataStr, "update");
      ...
      if (getInputPowerInterface && getInputPowerInterface.beforeExecute)
        masterDataStr = getInputPowerInterface.beforeExecute(masterDataStr, "insert");
    ...
    switch (respObj.code) {
      case 200:
        if (getInputPowerInterface && getInputPowerInterface.onAfterData)
          respObj.data = getInputPowerInterface.onAfterData(respObj.data);
        respObj.msg = Strings.UPDATE_INPUTPOWER_SUCCESS;
        break;
      case 400:
        respObj.msg = Strings.UPDATE_INPUTPOWER_ERROR;
        if (getInputPowerInterface && getInputPowerInterface.onError)
          respObj = getInputPowerInterface.onError(respObj);
        console.error("Unable to create the 'inputPower' - " + paramStr);
        break;
      case 403:
        respObj.msg = Strings.ACCESS_DENIED;
        if (getInputPowerInterface && getInputPowerInterface.onError)
          respObj = getInputPowerInterface.onError(respObj);
        console.error("User access denied when creating the 'inputPower' - " + paramStr);
        break;
      case 500:
        respObj.msg = Strings.SERVER_ERROR;
        if (getInputPowerInterface && getInputPowerInterface.onError)
          respObj = getInputPowerInterface.onError(respObj);
        console.error("Unexpected server error when creating the 'inputPower' - " + paramStr);
        break;
    }
...
try {
  ...
  var respObj = {
    code: 200,
    msg: Strings.READ_INPUTPOWER_SUCCESS
  };
  ...
  var onLoadRes = null;
  if (getInputPowerInterface && getInputPowerInterface.onLoad)
    onLoadRes = getInputPowerInterface.onLoad(params);
  ...
  if (onLoadRes && onLoadRes.override === true) {
    if (onLoadRes.resp) {
      if (onLoadRes.resp.code) {
        ...
        if (getInputPowerInterface && getInputPowerInterface.onError)
          respObj = getInputPowerInterface.onError(respObj);
        console.error("Unexpected server error when retrieving the inputPower - " + paramStr);
      }
    }
  } else {
    ...
    if (getInputPowerInterface && getInputPowerInterface.beforeData)
      beforeDataRes = getInputPowerInterface.beforeData(params);
    ...
    if (beforeDataRes && beforeDataRes.override === true) {
      ...
      if (params) {
        ...
        respObj.code = 400;
        respObj.msg = Strings.READ_INPUTPOWER_ERROR;
        if (getInputPowerInterface && getInputPowerInterface.onError)
          respObj = getInputPowerInterface.onError(respObj);
      }
    }
    ...
    switch (respObj.code) {
      case 200:
        if (getInputPowerInterface && getInputPowerInterface.afterData)
          respObj.data = getInputPowerInterface.afterData(respObj.data);
        respObj.msg = Strings.READ_INPUTPOWER_SUCCESS;
        break;
      case 400:
        respObj.msg = Strings.READ_INPUTPOWER_ERROR;
        if (getInputPowerInterface && getInputPowerInterface.onError)
      ...
      case 403:
        ...
        if (getInputPowerInterface && getInputPowerInterface.onError)
          respObj = getInputPowerInterface.onError(respObj);
        console.error("User access denied when retrieving the 'inputPower' - " + paramStr);
        break;
      case 500:
        respObj.msg = Strings.SERVER_ERROR;
        if (getInputPowerInterface && getInputPowerInterface.onError)
  ...
  if (getInputPowerInterface && getInputPowerInterface.onError)
    errorRespObj = getInputPowerInterface.onError(errorRespObj);
  console.error("Unexpected server error when creating the 'inputPower' - " + paramStr + "-" + errorRespObj.message);
