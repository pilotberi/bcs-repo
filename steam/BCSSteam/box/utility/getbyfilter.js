/*
	...
	Version : 2024
	Generated On : Mon Mar 09 2026 17:50:30 GMT+0530 (India Standard Time)
  ...
  if (getUtilityByFilterInterface && onLoadRes && onLoadRes.override === true) {
    ...
    if (getUtilityByFilterInterface && beforeDataRes && beforeDataRes.override === true) {
      ...
      if (params) {
        ...
        getUtilityByFilterQueryParams.cols = ["sfmp_code_id", "value", "reason", "record_date", "remarks", "created_by", "created_on", "modified_by", "modified_on"];
        getUtilityByFilterQueryParams.filter = [];

        if (params.sfmp_code_id && params.sfmp_code_id != 'all') {
          getUtilityByFilterQueryParams.filter.push({
            "col": "sfmp_code_id",
            "op": "=",
            "val": params.sfmp_code_id
          });
        }
