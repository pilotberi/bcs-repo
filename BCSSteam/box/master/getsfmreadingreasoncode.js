/*
	...
	Description : Get Service for sfmReadingReasonCode
...
var getSfmReadingReasonCodeInterface = require("getsfmreadingreasoncodeinterface.js");
...
function setDefaultMasterData(defaultArr) {
  ...
  var respObj = {
    code: 200,
    msg: Strings.UPDATE_SFMREADINGREASONCODE_SUCCESS
  };
  ...
  if (getSfmReadingReasonCodeInterface && getSfmReadingReasonCodeInterface.beforeExecute)
    queryParams = getSfmReadingReasonCodeInterface.beforeExecute(queryParams, "query");
  ...
  if (masterRespObj) {
    ...
    if (masterObj) { //master already has data, new data should be appended
      ...
      if (getSfmReadingReasonCodeInterface && getSfmReadingReasonCodeInterface.beforeExecute)
        masterDataStr = getSfmReadingReasonCodeInterface.beforeExecute(masterDataStr, "update");
      ...
      if (getSfmReadingReasonCodeInterface && getSfmReadingReasonCodeInterface.beforeExecute)
        masterDataStr = getSfmReadingReasonCodeInterface.beforeExecute(masterDataStr, "insert");
    ...
    switch (respObj.code) {
      case 200:
        if (getSfmReadingReasonCodeInterface && getSfmReadingReasonCodeInterface.onAfterData)
          respObj.data = getSfmReadingReasonCodeInterface.onAfterData(respObj.data);
        respObj.msg = Strings.UPDATE_SFMREADINGREASONCODE_SUCCESS;
        break;
      case 400:
        respObj.msg = Strings.UPDATE_SFMREADINGREASONCODE_ERROR;
        if (getSfmReadingReasonCodeInterface && getSfmReadingReasonCodeInterface.onError)
          respObj = getSfmReadingReasonCodeInterface.onError(respObj);
        console.error("Unable to create the 'sfmReadingReasonCode' - " + paramStr);
        break;
      case 403:
        respObj.msg = Strings.ACCESS_DENIED;
        if (getSfmReadingReasonCodeInterface && getSfmReadingReasonCodeInterface.onError)
          respObj = getSfmReadingReasonCodeInterface.onError(respObj);
        console.error("User access denied when creating the 'sfmReadingReasonCode' - " + paramStr);
        break;
      case 500:
        respObj.msg = Strings.SERVER_ERROR;
        if (getSfmReadingReasonCodeInterface && getSfmReadingReasonCodeInterface.onError)
          respObj = getSfmReadingReasonCodeInterface.onError(respObj);
        console.error("Unexpected server error when creating the 'sfmReadingReasonCode' - " + paramStr);
        break;
    }
...
try {
  ...
  var respObj = {
    code: 200,
    msg: Strings.READ_SFMREADINGREASONCODE_SUCCESS
  };
  ...
  var onLoadRes = null;
  if (getSfmReadingReasonCodeInterface && getSfmReadingReasonCodeInterface.onLoad)
    onLoadRes = getSfmReadingReasonCodeInterface.onLoad(params);
  ...
  if (onLoadRes && onLoadRes.override === true) {
    if (onLoadRes.resp) {
      if (onLoadRes.resp.code) {
        ...
        if (getSfmReadingReasonCodeInterface && getSfmReadingReasonCodeInterface.onError)
          respObj = getSfmReadingReasonCodeInterface.onError(respObj);
        console.error("Unexpected server error when retrieving the sfmReadingReasonCode - " + paramStr);
      }
    }
  } else {
    ...
    if (getSfmReadingReasonCodeInterface && getSfmReadingReasonCodeInterface.beforeData)
      beforeDataRes = getSfmReadingReasonCodeInterface.beforeData(params);
    ...
    if (beforeDataRes && beforeDataRes.override === true) {
      ...
      if (params) {
        ...
        respObj.code = 400;
        respObj.msg = Strings.READ_SFMREADINGREASONCODE_ERROR;
        if (getSfmReadingReasonCodeInterface && getSfmReadingReasonCodeInterface.onError)
          respObj = getSfmReadingReasonCodeInterface.onError(respObj);
      }
    }
    ...
    switch (respObj.code) {
      case 200:
        if (getSfmReadingReasonCodeInterface && getSfmReadingReasonCodeInterface.afterData)
          respObj.data = getSfmReadingReasonCodeInterface.afterData(respObj.data);
        respObj.msg = Strings.READ_SFMREADINGREASONCODE_SUCCESS;
        break;
      case 400:
        respObj.msg = Strings.READ_SFMREADINGREASONCODE_ERROR;
        if (getSfmReadingReasonCodeInterface && getSfmReadingReasonCodeInterface.onError)
      ...
      case 403:
        ...
        if (getSfmReadingReasonCodeInterface && getSfmReadingReasonCodeInterface.onError)
          respObj = getSfmReadingReasonCodeInterface.onError(respObj);
        console.error("User access denied when retrieving the 'sfmReadingReasonCode' - " + paramStr);
        break;
      case 500:
        respObj.msg = Strings.SERVER_ERROR;
        if (getSfmReadingReasonCodeInterface && getSfmReadingReasonCodeInterface.onError)
  ...
  if (getSfmReadingReasonCodeInterface && getSfmReadingReasonCodeInterface.onError)
    errorRespObj = getSfmReadingReasonCodeInterface.onError(errorRespObj);
  console.error("Unexpected server error when creating the 'sfmReadingReasonCode' - " + paramStr + "-" + errorRespObj.message);
