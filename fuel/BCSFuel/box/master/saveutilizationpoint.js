/*
	...
	Description : CombineMaster Save Service for utilizationPoint
...
var saveUtilizationPointInterface = require("saveutilizationpointinterface.js");
...
try {
  ...
  var onLoadRes = null;
  if (saveUtilizationPointInterface && saveUtilizationPointInterface.onLoad)
    onLoadRes = saveUtilizationPointInterface.onLoad(params);
  ...
  if (onLoadRes && onLoadRes.override === true) {
    if (onLoadRes.resp) {
      if (onLoadRes.resp.code) {
        ...
        if (saveUtilizationPointInterface && saveUtilizationPointInterface.onError)
          respObj = saveUtilizationPointInterface.onError(respObj);
    ...
    if (saveUtilizationPointInterface && saveUtilizationPointInterface.beforeData)
      beforeDataRes = saveUtilizationPointInterface.beforeData(params);
    ...
    if (beforeDataRes && beforeDataRes.override === true) {
      ...
      if (params && params.data) {
        ...
        if (saveUtilizationPointInterface && saveUtilizationPointInterface.beforeExecute)
          queryParams = saveUtilizationPointInterface.beforeExecute(queryParams, "query");
        ...
        if (masterRespObj) {
          ...
          if (masterObj) { //master already has data, new data should be appended
            ...
            if (saveUtilizationPointInterface && saveUtilizationPointInterface.beforeExecute)
              masterDataStr = saveUtilizationPointInterface.beforeExecute(masterDataStr, "update");
            ...
            if (saveUtilizationPointInterface && saveUtilizationPointInterface.beforeExecute)
              masterDataStr = saveUtilizationPointInterface.beforeExecute(masterDataStr, "insert");
    ...
    switch (respObj.code) {
      case 200:
        if (saveUtilizationPointInterface && saveUtilizationPointInterface.afterData)
          respObj.data = saveUtilizationPointInterface.afterData(respObj.data);
      ...
      case 400:
        ...
        if (saveUtilizationPointInterface && saveUtilizationPointInterface.onError)
          respObj = saveUtilizationPointInterface.onError(respObj);
        console.error("Unable to save the 'utilizationpoint' - " + paramStr);
        break;
      case 403:
        respObj.msg = Strings.ACCESS_DENIED;
        if (saveUtilizationPointInterface && saveUtilizationPointInterface.onError)
          respObj = saveUtilizationPointInterface.onError(respObj);
        console.error("User access denied when saving the 'utilizationpoint' - " + paramStr);
        break;
      case 500:
        respObj.msg = Strings.SERVER_ERROR;
        if (saveUtilizationPointInterface && saveUtilizationPointInterface.onError)
          respObj = saveUtilizationPointInterface.onError(respObj);
        console.error("Unexpected server error when saving the 'utilizationpoint' - " + paramStr);
        break;
    }
  ...
  if (saveUtilizationPointInterface && saveUtilizationPointInterface.onError)
    errorRespObj = saveUtilizationPointInterface.onError(errorRespObj);
  console.error("Unexpected server error when saving the utilizationpoint - " + paramStr + "-" + errorRespObj.message);
