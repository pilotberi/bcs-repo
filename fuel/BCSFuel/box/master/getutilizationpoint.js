...
var getUtilizationPointInterface = require("getutilizationpointinterface.js");
...
function setDefaultMasterData(defaultArr) {
  ...
  var respObj = {
    code: 200,
    msg: Strings.UPDATE_UTILIZATIONPOINT_SUCCESS
  };
  ...
  if (getUtilizationPointInterface && getUtilizationPointInterface.beforeExecute)
    queryParams = getUtilizationPointInterface.beforeExecute(queryParams, "query");
  ...
  if (masterRespObj) {
    ...
    if (masterObj) { //master already has data, new data should be appended
      ...
      if (getUtilizationPointInterface && getUtilizationPointInterface.beforeExecute)
        masterDataStr = getUtilizationPointInterface.beforeExecute(masterDataStr, "update");
      ...
      if (getUtilizationPointInterface && getUtilizationPointInterface.beforeExecute)
        masterDataStr = getUtilizationPointInterface.beforeExecute(masterDataStr, "insert");
    ...
    switch (respObj.code) {
      case 200:
        if (getUtilizationPointInterface && getUtilizationPointInterface.onAfterData)
          respObj.data = getUtilizationPointInterface.onAfterData(respObj.data);
        respObj.msg = Strings.UPDATE_UTILIZATIONPOINT_SUCCESS;
        break;
      case 400:
        respObj.msg = Strings.UPDATE_UTILIZATIONPOINT_ERROR;
        if (getUtilizationPointInterface && getUtilizationPointInterface.onError)
          respObj = getUtilizationPointInterface.onError(respObj);
        console.error("Unable to create the 'utilizationPoint' - " + paramStr);
        break;
      case 403:
        respObj.msg = Strings.ACCESS_DENIED;
        if (getUtilizationPointInterface && getUtilizationPointInterface.onError)
          respObj = getUtilizationPointInterface.onError(respObj);
        console.error("User access denied when creating the 'utilizationPoint' - " + paramStr);
        break;
      case 500:
        respObj.msg = Strings.SERVER_ERROR;
        if (getUtilizationPointInterface && getUtilizationPointInterface.onError)
          respObj = getUtilizationPointInterface.onError(respObj);
        console.error("Unexpected server error when creating the 'utilizationPoint' - " + paramStr);
        break;
    }
...
try {
  ...
  var respObj = {
    code: 200,
    msg: Strings.READ_UTILIZATIONPOINT_SUCCESS
  };
  ...
  var onLoadRes = null;
  if (getUtilizationPointInterface && getUtilizationPointInterface.onLoad)
    onLoadRes = getUtilizationPointInterface.onLoad(params);
  ...
  if (onLoadRes && onLoadRes.override === true) {
    ...
    if (getUtilizationPointInterface && getUtilizationPointInterface.beforeData)
      beforeDataRes = getUtilizationPointInterface.beforeData(params);
    ...
    if (beforeDataRes && beforeDataRes.override === true) {
      ...
      if (params) {
        ...
        respObj.code = 400;
        respObj.msg = Strings.READ_UTILIZATIONPOINT_ERROR;
        if (getUtilizationPointInterface && getUtilizationPointInterface.onError)
          respObj = getUtilizationPointInterface.onError(respObj);
      }
    }
    ...
    switch (respObj.code) {
      case 200:
        if (getUtilizationPointInterface && getUtilizationPointInterface.afterData)
          respObj.data = getUtilizationPointInterface.afterData(respObj.data);
        respObj.msg = Strings.READ_UTILIZATIONPOINT_SUCCESS;
        break;
      case 400:
        respObj.msg = Strings.READ_UTILIZATIONPOINT_ERROR;
        if (getUtilizationPointInterface && getUtilizationPointInterface.onError)
  ...
  if (getUtilizationPointInterface && getUtilizationPointInterface.onError)
    errorRespObj = getUtilizationPointInterface.onError(errorRespObj);
  console.error("Unexpected server error when creating the 'utilizationPoint' - " + paramStr + "-" + errorRespObj.message);
