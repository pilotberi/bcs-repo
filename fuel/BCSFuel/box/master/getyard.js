/*
	...
	Description : Get Service for yard
...
var getYardInterface = require("getyardinterface.js");
...
function setDefaultMasterData(defaultArr) {
  ...
  if (getYardInterface && getYardInterface.beforeExecute)
    queryParams = getYardInterface.beforeExecute(queryParams, "query");
  ...
  if (masterRespObj) {
    ...
    if (masterObj) { //master already has data, new data should be appended
      ...
      if (getYardInterface && getYardInterface.beforeExecute)
        masterDataStr = getYardInterface.beforeExecute(masterDataStr, "update");
      ...
      if (getYardInterface && getYardInterface.beforeExecute)
        masterDataStr = getYardInterface.beforeExecute(masterDataStr, "insert");
    ...
    switch (respObj.code) {
      case 200:
        if (getYardInterface && getYardInterface.onAfterData)
          respObj.data = getYardInterface.onAfterData(respObj.data);
        respObj.msg = Strings.UPDATE_YARD_SUCCESS;
        break;
      case 400:
        respObj.msg = Strings.UPDATE_YARD_ERROR;
        if (getYardInterface && getYardInterface.onError)
          respObj = getYardInterface.onError(respObj);
        console.error("Unable to create the 'yard' - " + paramStr);
        break;
      case 403:
        respObj.msg = Strings.ACCESS_DENIED;
        if (getYardInterface && getYardInterface.onError)
          respObj = getYardInterface.onError(respObj);
        console.error("User access denied when creating the 'yard' - " + paramStr);
        break;
      case 500:
        respObj.msg = Strings.SERVER_ERROR;
        if (getYardInterface && getYardInterface.onError)
          respObj = getYardInterface.onError(respObj);
        console.error("Unexpected server error when creating the 'yard' - " + paramStr);
        break;
    }
...
try {
  ...
  var onLoadRes = null;
  if (getYardInterface && getYardInterface.onLoad)
    onLoadRes = getYardInterface.onLoad(params);
  ...
  if (onLoadRes && onLoadRes.override === true) {
    ...
    if (getYardInterface && getYardInterface.beforeData)
      beforeDataRes = getYardInterface.beforeData(params);
    ...
    if (beforeDataRes && beforeDataRes.override === true) {
      ...
      if (params) {
        ...
        respObj.code = 400;
        respObj.msg = Strings.READ_YARD_ERROR;
        if (getYardInterface && getYardInterface.onError)
          respObj = getYardInterface.onError(respObj);
      }
    }
    ...
    switch (respObj.code) {
      case 200:
        if (getYardInterface && getYardInterface.afterData)
          respObj.data = getYardInterface.afterData(respObj.data);
        respObj.msg = Strings.READ_YARD_SUCCESS;
        break;
      case 400:
        respObj.msg = Strings.READ_YARD_ERROR;
        if (getYardInterface && getYardInterface.onError)
      ...
      case 403:
        ...
        if (getYardInterface && getYardInterface.onError)
          respObj = getYardInterface.onError(respObj);
        console.error("User access denied when retrieving the 'yard' - " + paramStr);
        break;
      case 500:
        respObj.msg = Strings.SERVER_ERROR;
        if (getYardInterface && getYardInterface.onError)
  ...
  if (getYardInterface && getYardInterface.onError)
    errorRespObj = getYardInterface.onError(errorRespObj);
  console.error("Unexpected server error when creating the 'yard' - " + paramStr + "-" + errorRespObj.message);
