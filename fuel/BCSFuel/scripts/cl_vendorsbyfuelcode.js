/*
	...
	Version : 2024
	Generated On : Tue Apr 07 2026 09:52:25 GMT+0530 (India Standard Time)
...
function onSaveVendorBtnClick(e) {
  ...
  var checkStatus = validate(VendorArr);
  ...
  var finalData = [];
  VendorArr.forEach(function(item) {
...
function validate(dataArr) {
  ...
  dataArr.forEach(function(VendorObj) {
    var errorStr = "";
    var rowNum = VendorObj._rowNum;

    function addError(error) {
      errorStr += error + "<br>";
    }

    var rowTitle = VendorObj.name || VendorObj.undefined || VendorObj.id || "-";

    if (VendorInterface && VendorInterface.getRowTitle) {
      var customTitle = VendorInterface.getRowTitle(VendorObj, dataSources);
    ...
    if (VendorObj.fuel_code_id == null || VendorObj.fuel_code_id === '') {
      addError(Strings.VENDOR_INVALID_FUEL_CODE_ID);
    }

    // C. External Interface Validation
    if (VendorInterface && VendorInterface.addValidation) {
      var extErr = VendorInterface.addValidation(VendorObj, dataSources);
  ...
  if (validateError.length > 0) {
    ...
    var promptTitle = (typeof Strings !== 'undefined' && Strings.VALIDATE_VENDOR_PROMPT) ? Strings.VALIDATE_VENDOR_PROMPT : "Validation Errors";
    var objTitle = (typeof Strings !== 'undefined' && Strings.VENDOR_TITLE) ? Strings.VENDOR_TITLE : "Vendor";
