...
function validate(rowData) {
	...
	if (rowData[1] == null || rowData[1] === '') { //this is to validate yard_code
		s_info(Strings.VALIDATION_ERROR_TITLE, Strings.YARD_INVALID_YARD_CODE, dlgOptions);
		return false;
	}
